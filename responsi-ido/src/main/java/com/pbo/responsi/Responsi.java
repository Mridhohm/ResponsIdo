...
import eventdiskonan.Event;
import com.pbo.responsi.view.CartView;
import java.util.List;
import javax.swing.JOptionPane;
import javax.swing.SwingUtilities;
import eventdiskonan.Diskon;
...
public class Responsi {
    ...
    public static void main(String[] args) {
        try {
            DatabaseKonek.initializeDatabase();
            ...
            JOptionPane.showMessageDialog(
                ...
                + e.getMessage() + "\n\n"
                + "Pastikan:\n"
                + "1. MySQL server harus sudah berjalan\n"
        ...
        Diskon discountStrategy = new Event();
